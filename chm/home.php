        ...
        <div class="main-panel">
            ...
            <div class="container" style="background-color: #dbdde0 !important;">
                <div class="page-inner">
                    ...
                    <div class="modal fade" id="ch_calendarModal" tabindex="-1" aria-labelledby="calendarModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="calendarModalLabel">Event Calendar</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <button class="container-fluid btn card card-round justify-content-center" style="height: 100px; border-radius: 10px" data-bs-toggle="modal" data-bs-target="#ch_calendarModal">
                                        <div class="row card-body align-items-center justify-content-between">
                                            <div class="col mb-3 fs-2 d-flex align-items-center" style="height: 100%;">
                                                <i class="bi bi-calendar3 fs-1 me-4" style="margin-top: 3px;"></i>
                                                <span>Church</span>
